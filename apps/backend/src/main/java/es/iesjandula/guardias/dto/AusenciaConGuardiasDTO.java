...
@Data
@Schema(description = "DTO de respuesta para ausencias con información de guardias (incluye ID generado)")
public class AusenciaConGuardiasDTO {
    
    @Schema(description = "ID único de la ausencia (generado automáticamente)", example = "1", accessMode = Schema.AccessMode.READ_ONLY)
    private Long id;
    ...
    @Schema(description = "Grupo al que afecta la ausencia", example = "1DAW")
    ...
    @Schema(description = "Email del profesor que cubre la guardia", example = "guardia@instituto.edu")
